    ...
    <footer className="hairline-t mt-32">
      <div className="container grid grid-cols-2 md:grid-cols-6 gap-8 py-16">
        <div className="col-span-2 md:col-span-2">
          <LogoLockup />
          <p className="mt-5 text-xs text-muted-foreground max-w-xs leading-relaxed">
            Performance advertising, re-engineered. Predictive, multi-platform, experiment-native.
          </p>
          <div className="mt-6 flex flex-wrap gap-1.5">
            {SOCIALS.map((s) => (
              <a
                ...
                target="_blank"
                rel="noopener me"
                aria-label={`EIAAW Solutions on ${s.label}`}
                title={s.label}
                className="inline-flex h-9 w-9 items-center justify-center rounded-md text-muted-foreground transition-colors duration-150 hover:text-foreground hover:bg-foreground/5 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-foreground"
              >
